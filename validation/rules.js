...
const checkDate=/(^[0-9]{4}-[0-9]{2}-[0-9]{2}\s[0-9]{2}:[0-9]{2}:[0-9]{2}$)|(^(٠|١|٢|٣|٤|٥|٦|٧|٨|٩){4}-(٠|١|٢|٣|٤|٥|٦|٧|٨|٩){2}-(٠|١|٢|٣|٤|٥|٦|٧|٨|٩){2}\s(٠|١|٢|٣|٤|٥|٦|٧|٨|٩){2}:(٠|١|٢|٣|٤|٥|٦|٧|٨|٩){2}:(٠|١|٢|٣|٤|٥|٦|٧|٨|٩){2}$)/;
...
const checkDescription=/^(([a-zA-z0-9](\s)?)|((ه|أ|ب|ت|ث|ج|ح|خ|د|ذ|ر|ز|س|ش|ص|ض|ط|ظ|ع|غ|ف|ق|ك|ل|م|ن|هـ|و|ي|ئ|ا|ء|ؤ|ى|ة|٠|١|٢|٣|٤|٥|٦|٧|٨|٩)(\s)?)){0,20000}$/;
